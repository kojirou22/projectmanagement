...
// import PeiChartOutlineOutlinedIcon from "@mui/icons-material/PeiChartOutlineOutlined";
                    ...
                    {!isCollapsed && (
                        <Box mb="25px">
                            ...
                            <Box textAlign="center">
                                <Typography variant="h2" color={colors.grey[100]} fontWeight="bold" sx={{ m: "10px 0 0 0"}}>Mushpic Andi</Typography>
